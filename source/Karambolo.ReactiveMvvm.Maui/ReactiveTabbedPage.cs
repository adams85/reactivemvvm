...
{
    public abstract partial class ReactiveTabbedPage<TViewModel> : TabbedPage, IReactiveView<TViewModel>
        where TViewModel : class
    {
        public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
            ...
            propertyChanged: (obj, _, newValue) => ((ReactiveTabbedPage<TViewModel>)obj).AdjustDataContext(@this => @this.BindingContext = newValue));

        private bool _adjustingDataContext;

        private void AdjustDataContext(Action<ReactiveTabbedPage<TViewModel>> update)
        {
