...
{
    public abstract partial class ReactiveShell<TViewModel> : Shell, IReactiveView<TViewModel>
        where TViewModel : class
    {
        public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
            ...
            propertyChanged: (obj, _, newValue) => ((ReactiveShell<TViewModel>)obj).AdjustDataContext(@this => @this.BindingContext = newValue));

        private bool _adjustingDataContext;

        private void AdjustDataContext(Action<ReactiveShell<TViewModel>> update)
        {
