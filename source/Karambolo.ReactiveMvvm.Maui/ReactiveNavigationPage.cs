...
{
    public abstract partial class ReactiveNavigationPage<TViewModel> : NavigationPage, IReactiveView<TViewModel>
        where TViewModel : class
    {
        public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
            ...
            propertyChanged: (obj, _, newValue) => ((ReactiveNavigationPage<TViewModel>)obj).AdjustDataContext(@this => @this.BindingContext = newValue));

        private bool _adjustingDataContext;

        private void AdjustDataContext(Action<ReactiveNavigationPage<TViewModel>> update)
        {
