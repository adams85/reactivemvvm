...
{
    public abstract partial class ReactiveContentPage<TViewModel> : ContentPage, IReactiveView<TViewModel>
        where TViewModel : class
    {
        public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
            ...
            propertyChanged: (obj, _, newValue) => ((ReactiveContentPage<TViewModel>)obj).AdjustDataContext(@this => @this.BindingContext = newValue));

        private bool _adjustingDataContext;

        private void AdjustDataContext(Action<ReactiveContentPage<TViewModel>> update)
        {
