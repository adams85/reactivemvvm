...
{
    public abstract partial class ReactiveCarouselView<TViewModel> : CarouselView, IReactiveView<TViewModel>
        where TViewModel : class
    {
        public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
            ...
            propertyChanged: (obj, _, newValue) => ((ReactiveCarouselView<TViewModel>)obj).AdjustDataContext(@this => @this.BindingContext = newValue));

        private bool _adjustingDataContext;

        private void AdjustDataContext(Action<ReactiveCarouselView<TViewModel>> update)
        {
